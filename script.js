...
const sahoStaff = "キャラクターデザイン：quef<br>原音設定：Natsukawa Sakuro";
 ...
 variants:[
  {
   ...
   staff:"キャラクターデザイン：quef<br>原音設定：Natsukawa Sakuro"
  },
  {
   ...
   staff:"キャラクターデザイン：quef<br>原音設定：肺叶"
  }
 ]
},
{
 ...
 variants:[{
  ...
  facts:[["身長","159 cm"],["年齢","18 歳"],["性別","女"],["好き","チョコレート"],["嫌い","猫"],["人称","ぼく / あんた"]],
  special:"[a R]　通常語尾<br>[a 吸R]　語尾ブレス（吸気）<br>[a 息R]　語尾ブレス（呼気）<br>[br]　閉口ブレス",
  staff:"キャラクターデザイン：quef<br>サンプリング：グロック19のマガジン装填音"
 }]
},
{
 ...
 variants:[{
  ...
  special:"[a R]　通常語尾<br>[a 吸R]　語尾ブレス（吸気）<br>[a 息R]　語尾ブレス（呼気）<br>[br]　閉口ブレス",
  staff:"キャラクターデザイン：quef<br>原音設定：itsukiMNE<br>イラスト：兔斯<br>サンプリング：グロック19のマガジン装填音・猫が爪を研ぐ"
 }]
},
{
 ...
 variants:[{
  ...
  facts:[["身長","155 cm"],["年齢","1? 歳"],["性別","女"],["好き","チョコレートクッキー"],["嫌い","弱いもの、曖昧なもの、柔らかいもの"],["人称","わたし / あなた"]],
  special:"[a R]　通常語尾<br>[a Rb]　語尾ブレス（吸気）<br>[a Rx]　語尾ブレス（呼気）<br>[br1～4]　閉口ブレス<br>[a・]　母音声門閉鎖（後）<br>[・あ]　母音声門閉鎖（前）<br>[a k]　VC",
  staff:"キャラクターデザイン：quef<br>原音設定：Natsukawa Sakuro"
 }]
}
...
const aboutJa = `
<p class="welcome">ようこそ。<br>ここで保管されているのは、いつからそこにあったのかも分からない、一台の古い折りたたみ携帯電話です。</p>
<p>電源を入れると、知らない名前がいくつも並んでいます。持ち主を示すものは見当たりません。残されているのは連絡先と、途切れた着信履歴、短い通話記録、それから消しきれなかった会話の断片だけです。</p>
<p>誰がどんな人だったのかを説明する文章は、ほとんど残っていません。その代わり、返事の癖や、何度も使われる言葉、妙に長い沈黙のあとに送られた一文があります。そうした小さな痕跡を拾っていくうちに、名前だけだった誰かに、少しずつ輪郭が生まれていくかもしれません。</p>
<p>とはいえ、記録は記録にすぎません。抜け落ちた時間もあれば、送られなかった言葉もあります。ここに残っているものだけで、その人のすべてを知ることはできないでしょう。</p>
<p>だから、古い端末を偶然拾い、ほんの少しだけ中を覗いてしまったような気持ちで。気になる名前があれば、そっと開いてみてください。</p>
<p>声と記録は、まだここに残っています。</p>
<p class="aside">UTAU voicebanks / character records / trial audio / distribution files</p>`;

const aboutZh = `
<p class="welcome">欢迎光临。<br>这里保存着一部不知道从什么时候起，就一直被遗落在这里的旧式翻盖手机。</p>
<p>按下电源，通讯录里排列着一串陌生的名字，却找不到任何能够说明手机主人身份的东西。剩下的只有联系方式、断掉的来电记录、短暂的通话痕迹，以及一些没能被彻底清除的聊天片段。</p>
<p>这里几乎没有谁为这些联系人写下完整的介绍。更多时候，留下来的只是某种回复习惯、一句反复出现的话，或者在漫长的沉默之后突然发来的几个字。沿着这些不起眼的痕迹继续翻下去，原本只是一个名字的人，也许会一点点显出轮廓。</p>
<p>不过，记录终究只是记录。中间有缺失的时间，也有从未发送出去的话。仅凭手机里留下来的这些东西，大概永远不足以真正认识一个人。</p>
<p>所以，把这里当作一次偶然吧。像是不小心捡到了一部旧手机，又忍不住往里面多看了几眼。如果某个名字让你在意，就轻轻点开它。</p>
<p>那些声音和记录，暂时还没有消失。</p>
