...
const groups = [
{
 ...
 variants:[
  {id:"saho-main",label:"無印",type:"5音階連続音 / VCV",pitch:"A3 / C4 / E4 / G4 / C5",img:"images/足立サホ_無印.png",audio:"audio/足立サホ_無印.wav",zip:"download/足立サホ_無印.zip",desc:sahoDesc,facts:sahoProfile,special:sahoSpecial,staff:sahoStaff},
...
},
{
 ...
 variants:[
  ...
  },
  {
   ...
   staff:"キャラクターデザイン：quef<br>原音設定：肺叶<br>イラスト：SS<br>ナカノヒト：ヒダーナ"
  }
 ]
},
{
...
},
{
 ...
 variants:[{
  id:"kiri-main",label:"無印",type:"1音階単独音 / CVVC",pitch:"F4",
  img:"images/月代キリ_無印.png",audio:"audio/月代キリ_無印.wav",zip:"download/月代キリ_無印.zip",
  ...
  special:"[a R]　通常語尾<br>[a Rb]　語尾ブレス（吸気）<br>[a Rx]　語尾ブレス（呼気）<br>[br1～4]　閉口ブレス<br>[a・]　母音声門閉鎖（後）<br>[・あ]　母音声門閉鎖（前）<br>[a k]　VC",
  staff:"キャラクターデザイン：quef<br>原音設定：Natsukawa Sakuro<br>イラスト：SS<br>ナカノヒト：ラン"
 },
 {
  id:"kiri-vintage",label:"Vintage",type:"1音階単独音 / CVVC",pitch:"B4",
  img:"images/月代キリ_Vintage.png",audio:"audio/月代キリ_Vintage.wav",zip:"download/月代キリ_Vintage.zip",
  desc:"好き嫌いがはっきりしていて、明るく奔放な少女。<br>自分が信じる「正しさ」を証明するため、永遠の一部となった。",
  facts:[["身長","155 cm"],["年齢","16 歳"],["性別","女"],["好き","チョコレートクッキー"],["嫌い","弱いもの、曖昧なもの、柔らかいもの"],["人称","わたし / あなた"]],
  special:"[a R]　通常語尾<br>[a Rb]　語尾ブレス（吸気）<br>[a Rx]　語尾ブレス（呼気）<br>[br1～4]　閉口ブレス<br>[a・]　母音声門閉鎖（後）<br>[・あ]　母音声門閉鎖（前）<br>[a k]　VC",
  staff:"キャラクターデザイン：quef<br>原音設定：Natsukawa Sakuro<br>イラスト：SS<br>ナカノヒト：ラン"
...
<h3>■ 禁止事項</h3>
<p>以下の用途・行為は禁止します。<br>
・AI学習、機械学習、モデル学習、学習用データセット等への利用<br>
・Hifisampler 等、AI・機械学習アルゴリズムを中核として使用するエンジン、レンダラー、リサンプラー等で本音源を使用すること<br>
・本音源に関する音声、設定ファイル、原音、画像、その他一切の素材を、DiffSinger 用の音源・モデル・データセット等の制作に使用すること<br>
・本音源に同梱されている立ち絵・イラスト・画像パック等の素材を、30秒前後の短尺動画（Shorts / TikTok / Reels 等を含む）、鬼畜動画、顔・身体の接合や切り貼り等の編集用途に使用すること<br>
・許可のない再配布、販売、転載<br>
・他作品の盗用、過度な模倣、第三者の権利を侵害する利用<br>
・政治・宗教・信仰に関する主張や宣伝を目的とした利用<br>
・公序良俗に反する内容、誹謗中傷、人格を著しく貶める表現<br>
・未成年者の性的描写を含む表現<br>
・妊娠、著しく残虐な描写、その他過度にセンシティブな内容<br>
・キャラクターを動物・ペットとして扱う表現<br>
・その他、制作者が本音源またはキャラクターの扱いとして不適切と判断したもの</p>
<h3>■ 二次創作・派生キャラクター</h3>
...
<h3>■ 禁止事项</h3>
<p>禁止以下用途及行为：<br>
・用于 AI 学习、机器学习、模型训练、训练数据集等相关用途<br>
・禁止使用 Hifisampler 等以 AI / 机器学习算法为核心的引擎、渲染器、重采样器等处理或使用本音源<br>
・禁止将与本音源相关的音频、原音、设置文件、图像及其他任何素材用于制作 DiffSinger 音源、模型、数据集或相关内容<br>
・本音源附带的立绘、插画、图包等视觉素材，禁止用于任何形式的约 30 秒短视频（包括 Shorts / TikTok / Reels 等）、鬼畜视频、接头、脸部或身体拼接及类似剪贴合成用途<br>
・未经许可进行再配布、销售或转载<br>
・盗用他人作品、过度模仿，或以其他方式侵犯第三方权利<br>
・以政治、宗教、信仰的宣传或主张为目的进行使用<br>
・违反公序良俗的内容、诽谤中伤或严重贬损人格的表现<br>
・包含未成年人的性描写<br>
・妊娠、极度残虐或其他过度敏感的内容<br>
・将角色作为动物或宠物进行表现<br>
・其他由制作者判断为不适合本音源或角色的使用方式</p>
<h3>■ 二次创作与派生角色</h3>
